...
button5.setStyleSheet('background-color:gray;color:white')
button6.setStyleSheet('background-color:gray;color:white')
button7.setStyleSheet('background-color:gray;color:white')
button8.setStyleSheet('background-color:gray;color:white')
button9.setStyleSheet('background-color:gray;color:white')
